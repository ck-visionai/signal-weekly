...
#show: make-glossary
#show: report-theme.with(title: "The Executive Screen", author: "Signal Weekly · A Signrl publication", rhythm: "longform", body-size: 10pt, running-header: false)
...
#align(left)[#text(size: 8pt, weight: "bold", fill: cobalt)[SAMPLE BRIEFING 06 · READER EDITION] #h(1fr) #text(size: 8pt, weight: "bold", fill: muted)[SIGNAL WEEKLY · A SIGNRL PUBLICATION]]
#v(0.7em)
...
#set text(size: 10pt)
#v(0.45em)
#small([Further reading: #link("https://wasserman.nyu.edu/channels/interviewing-negotiation-process/")[NYU Wasserman Center — Interviewing & Negotiation Process]. This link is provided for general career-preparation context. Signal Weekly is a Signrl publication; this educational reader edition does not guarantee a career outcome.])
