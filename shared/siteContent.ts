...
export const defaultSiteContent: SiteContent = {
  ...
  hero: {
    ...
    frequency: "One concise Friday briefing",
  ...
  navigation: {
    ...
    subscribeLabel: "Start with the free working page",
    browseArchiveLabel: "Preview the Sample Library",
    valueCtaLabel: "Get the free working page",
    fallbackSubscribeLabel: "Start with the free working page",
  },
  inside: {
  ...
  closing: {
    ...
    heading: "Start with a working page.",
    emphasis: "Then build from there.",
    description: "Begin with the complete free page today. Then receive a concise Friday brief for the career decision in front of you.",
    ctaLabel: "Start with my free working page",
