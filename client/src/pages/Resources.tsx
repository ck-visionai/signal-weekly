    ...
    <div className="resources-page">
      ...
      <main>
        ...
        <section className="resource-next" aria-labelledby="next-title">
          <div><p className="resource-number">THE NEXT FILES</p><h2 id="next-title">The library grows every week<br /><em>designed to empower your next career decision.</em></h2></div>
