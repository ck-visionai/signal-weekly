...
export const sampleIssues: SampleIssue[] = [
  { number: "01", title: "The Career Evidence Working Page", subtitle: "Turn broad claims into credible evidence.", previewUrl: `${storage}/career-weekly-edition-01-career-evidence-working-page-preview_a2ff6bdd.pdf`, completeUrl: `${storage}/career-weekly-edition-01-career-evidence-working-page-complete_0f14d2ad.pdf`, freeComplete: true, deliveryLabel: "Complete edition available now" },
