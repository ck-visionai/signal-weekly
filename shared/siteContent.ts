...
export const defaultSiteContent: SiteContent = {
  identity: {
    ...
    logoUrl: "/manus-storage/career-signal-updated-mark-darknavy_2cf79fac.png",
  },
  hero: {
  ...
  navigation: {
    ...
    subscribeLabel: "Access my complimentary issue",
    browseArchiveLabel: "Preview the Sample Library",
    valueCtaLabel: "Access my complimentary issue",
    fallbackSubscribeLabel: "Access my complimentary issue",
  },
  inside: {
