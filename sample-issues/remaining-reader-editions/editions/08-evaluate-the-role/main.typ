...
#show: make-glossary
#show: report-theme.with(title: "Questions That Help You Evaluate the Role", author: "Career Weekly · A Signrl publication", rhythm: "longform", body-size: 10pt, running-header: false)
...
#align(left)[#text(size: 8pt, weight: "bold", fill: cobalt)[SAMPLE BRIEFING 08 · READER EDITION] #h(1fr) #text(size: 8pt, weight: "bold", fill: muted)[CAREER WEEKLY · A SIGNRL PUBLICATION]]
#v(0.7em)
